---
date: 2020-07-29
description: A getting started tutorial for EmbedIO
categories:
  - Blog
  - Development
  - C#
...
# Getting Started with EmbedIO

I've been trying to use [EmbedIO](https://github.com/unosquare/embedio) but they have no getting started tutorial. Add to that the code samples in their project page are code snippets, so don't compile and run without finding more code from their samples directory, the learning curve is quite steep.

This is my attempt at compiling a working getting started tutorial.
